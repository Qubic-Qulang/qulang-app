...
const ConfirmTxModal = ({ tx, open, onClose, onConfirm, onTransactionComplete }) => {
    ...
    return (
        <>
            {open && (
                <div
                    className="w-full p-5 h-full fixed top-0 left-0 overflow-x-hidden overflow-y-auto z-50 bg-smoke-light flex backdrop-blur-lg transition-all duration-300"
                    onClick={onClose}
                >
