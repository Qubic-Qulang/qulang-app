...
const ConnectModal = ({ open, onClose }) => {
    ...
    return (
        <>
            {open && (
                <div
                    className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-lg transition-all duration-300"
                    onClick={closeModal}
                >
                    <Card
                    ...
                    >
                        ...
                        <div className="flex justify-between items-center mb-4">
                            <img src="qubic-connect.svg" alt="Qubic Connect" className="h-6" />
                            <img src="close.svg" alt="Close" className="w-5 h-5 cursor-pointer" onClick={closeModal} />
                        </div>
                            ...
                            <div className="space-y-4 text-white">
                                ...
                                {!connected && (
                                    <>
                                        ...
                                        >
                                            <img src="wallet-connect.svg" alt="WalletConnect Icon" className="h-6 w-6" />
